package BuildFeatures_FileContentReplacerKotlin_UserDefinedReplacer_WithSwabra_LockFileI
...
version = "10.0"
project(BuildFeatures_FileContentReplacerKotlin_UserDefinedReplacer_WithSwabra_LockFileI.Project)